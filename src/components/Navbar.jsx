...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-7 items-center flex justify-between">
        ...
        {/* ul navbar + scroll transition */}
        <ul className={`menu flex items-center gap-10 md:static fixed left-1/2 -translate-x-1/2 md:translate-x-0  md:opacity-100 bg-white/30 backdrop-blur-md p-4 rounded-bl-2xl rounded-br-2xl md:bg-transparent transition-all md:transition-none ${active ? "top-0 opacity-100" : "-top-10  opacity-0"}`}> 
            <li>
